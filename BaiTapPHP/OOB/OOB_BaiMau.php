...
class HinhChuNhat extends Hinh {
    ...
    public function setCanh2() {
        $this->Canh2 = $this->dodai * 2;
    }

    // Tính chu vi
    public function tinh_CV() {
        return ($this->Canh2 + $this->dodai) * 2;
    }
...
if(isset($_POST['tinh'])){
    ...
    if(isset($_POST['hinh']) && ($_POST['hinh'])=="hcn"){
		...
		$str= "Diện tích của hình chữ nhật ".$hcn->getTen()." là : ".$hcn->tinh_DT()." \n".
				...
				"Chu vi của chữ nhật ".$hcn->getTen()." là : ".$hcn->tinh_CV();
	}
